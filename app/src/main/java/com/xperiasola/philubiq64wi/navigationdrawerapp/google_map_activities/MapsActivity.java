...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng makati = new LatLng(14.556586, 121.023415);
        mMap.addMarker(new MarkerOptions().position(makati).title("Marker in Sydney"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(makati));
